...
export default function App() {
  ...
  const { expired, daysLeft } = getTrialInfo()
    ...
    <div className="app-shell">
      ...
      {daysLeft <= 3 && (
        <div style={{
          ...
          background: daysLeft <= 1 ? 'rgba(239,68,68,0.15)' : 'rgba(251,191,36,0.12)',
          border: `1px solid ${daysLeft <= 1 ? 'rgba(239,68,68,0.4)' : 'rgba(251,191,36,0.3)'}`,
